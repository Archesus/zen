...
const Hero = () => {
    ...
    return (
        <main className="relative h-dvh w-screen overflow-x-hidden">
            ...
            {isLoading && (
                <div className="flex-center z-[100] h-dvh w-screen absolute overflow-hidden bg-violet-50">
            ...
            <div id="video-frame" className="relative z-10 overflow-hidden rounded-lg bg-blue-75 h-dvh w-screen">
                <div>
                    <div className="mask-clip-path absolute-center absolute z-50 overflow-hidden rounded-lg size-64 cursor-pointer">
                    ...
                    <video
                        ...
                        muted
                        id="next-video"
                        className="absolute invisible z-20 absolute-center size-64 object-cover object-center"
                        onLoadedData={handleVideoLoad}
                    />
